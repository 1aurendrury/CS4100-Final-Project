...
# using 0.15 as a bonus factor for reusing the same card multiple times in a row (to reduce annual fees)
# basing this heavily off of my PA2 implementation
def Q_learning(
    env,
    episodes=2000,
    gamma=0.95,
...
# basing this off of my PA2 implementation as well
...
# return value atm is form of {category: {card_idx: int, q_value: float}}
...
# this will essentially be the entry point for the program
def main():
